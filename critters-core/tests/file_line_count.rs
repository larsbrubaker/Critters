...
//!
//! Mirrors the Marbles / agg-gui policy: every first-party file in the
//! workspace stays at or below 800 lines. When this test fails, split the
//! offending file into focused sibling modules instead of compressing
//! whitespace / comments to slip under the cap.
...
fn first_party_project_files_stay_under_line_limit() {
    let workspace_root = Path::new(env!("CARGO_MANIFEST_DIR"))
        .parent()
        .expect("critters-core should live under the workspace root");
