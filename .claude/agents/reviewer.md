...
- **Project conventions** — this repo's CLAUDE.md rules: file header comments, 800-line limit, tests accompanying bug fixes, Rust naming, agg-gui-only rendering, behaviour matching `reference/game.js`. Run `git diff` and `cargo` from the repo root.
